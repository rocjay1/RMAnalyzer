...
# Usage: Run '.\Create-DeploymentPackage.ps1' from the RMAnalyzer\scripts directory
...
if (-not (Test-Path -Path "..\dist\packages\*")) {
    # Try to create the missing directories. If dist\packages exists but is empty, silently continue.
